        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="featured-text">
              <h2 class="pb-3">
                ¿Porqué <span class="orange-text">Fruitkha?</span>
              </h2>
              <div class="row">
    ...
    <section class="shop-banner">
      <div class="container">
        <h3>
          ...
          con un gran <span class="orange-text">Descuento...</span>
        </h3>
        ...
        <a href="shop.php" class="cart-btn btn-lg">Descubre</a>
      </div>
    </section>
    <!-- end shop banner -->
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="single-team-item">
              ...
              <h4>Jimmy Doe <span>Granjero</span></h4>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-team-item">
              ...
              <h4>Marry Doe <span>Granjera</span></h4>
              <ul class="social-link-team">
                <li>
                  <a href="#" target="_blank"
                    ><i class="fab fa-facebook-f"></i
          ...
          <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
            <div class="single-team-item">
              ...
              <h4>Simon Joe <span>Granjero</span></h4>
              <ul class="social-link-team">
                <li>
                  <a href="#" target="_blank"
                    ><i class="fab fa-facebook-f"></i
            ...
            <div class="testimonial-sliders">
              <div class="single-testimonial-slider">
                ...
                <div class="client-meta">
                  <h3>Saira Hakim <span>Asistente en ventas</span></h3>
              ...
              <div class="single-testimonial-slider">
                ...
                <div class="client-meta">
                  <h3>David Niph <span>Asistente en ventas</span></h3>
                  <p class="testimonial-body">
                    " Sed ut perspiciatis unde omnis iste natus error veritatis
                    et quasi architecto beatae vitae dict eaque ipsa quae ab
                    illo inventore Sed ut perspiciatis unde omnis iste natus
