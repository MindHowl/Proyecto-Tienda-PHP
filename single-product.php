			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="back/uploads/<?php echo $row['foto']; ?>" alt="">
					</div>
				</div>
				<div class="col-md-7">
					<div class="single-product-content">
						<h3><?php echo $row['modelo']; ?></h3>
						<p class="single-product-pricing"><span>Por Kg</span> $<?php echo $row['precio']; ?></p>
						...
						<div class="single-product-form">
							...
							<p><strong>Categorias: </strong>Fruits, Organic</p>
						</div>
						<h4>Comparte:</h4>
