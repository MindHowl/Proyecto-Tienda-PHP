...
<head>
	...
	<title>22586 - Panel de Contenidos</title>
...
<body>
	<div class="row-fluid">
		<div class="well span5 center login-box">
			<p><img style="max-width:150px; max-height:150px" src="logo/logo.jpg"></p>
			...
			<?php if ($_REQUEST['mensajee'] != NULL) { ?>
				<div class="clearfix"></div>
				<div class="alert alert-error">
					<strong>ERROR!</strong> <?php echo $_REQUEST['mensajee']; ?>
				</div>
				<?php } ?>
			<?php if ($_REQUEST['mensaje'] != NULL) { ?>
				<div class="clearfix"></div>
